...
Included are vis for all of the SDK functions and a very simple example that reads a single float type tag from a logix PLC, writes a new value, then reads it again.
These vi's should work on Labview 2019 for Linux 64 bit, Windows 64 bit, and Windows 32 bit.  If you need an ealier version let me know.
